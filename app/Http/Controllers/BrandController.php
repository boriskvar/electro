...
class BrandController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('brands.index', compact('brands')); // Возвращаем представление с переданными данными
    }
    ...
    public function create()
    {
        ...
        return view('brands.create', compact('brands')); // Передаем переменную в представление
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('brands.index')->with('success', 'Бренд создан успешно!');
    }
    ...
    public function destroy(Brand $brand)
    {
        ...
        return redirect()->route('brands.index')->with('success', 'Бренд успешно удалён.');
    }
