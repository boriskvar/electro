    ...
    <form action="{{ route('brands.update', $brand->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="mt-2">
                ...
                <img src="{{ asset($logoPath) }}" alt="{{ $brand->name }} Logo" class="brand-logo" style="max-width: 200px;">
                @else
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="popularity" name="popularity" value="{{ old('popularity', $brand->popularity) }}" min="0">
        </div>
        <div class="form-group">
        ...
        <a href="{{ route('brands.index') }}" class="btn btn-warning">Назад к списку брендов</a>
    </form>
</div>
@endsection
